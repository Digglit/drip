...
import { viewPreviousOrdersHandler, viewCustomerDetailsHandler } from '../../../../../actions'
  ...
  findCustomerHandler = (name) => {
    for (let i = 0; i < this.state.customers.length; ++i) {
      if (this.state.customers[i].customerData.name === name) {
        return this.props.viewCustomerDetailsHandler(20, this.state.customers[i].customerData)
      }
    }
  }
...
export default connect(mapStateToProps, { viewPreviousOrdersHandler, viewCustomerDetailsHandler })(ViewPreviousOrders)
