...
import { changePage, displayCustomerDetails, displayPreviousOrders } from '../../../../actions/portal'
    ...
    return (
      <motion.div className='viewCompletedOrdersPageContainer' initial={pageTransition.initial} animate={pageTransition.in} exit={pageTransition.out} transition={{ duration: transitionDuration }}>
        ...
        <div className='viewCompletedOrdersFooterContainer'>
          ...
          <button className='viewCompletedOrdersFooterButton primaryButton' onMouseDown={this.props.displayPreviousOrders}>View Older Orders</button>
        </div>
      </motion.div>
    )
  }
...
export default connect(mapStateToProps, { changePage, displayCustomerDetails, displayPreviousOrders })(ViewCompletedOrders)
